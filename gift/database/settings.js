...
const DEFAULT_SETTINGS = {
    PREFIX: ".",
    OWNER_NAME: "𝐃𝐚𝐫𝐤𝐥𝐨𝐚𝐝",
    OWNER_NUMBER: "254795463911",
    BOT_NAME: "𝐃𝐀𝐑𝐊 𝐋𝐎𝐀𝐃 𝐗𝐌𝐃",
    FOOTER: "ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴅᴀʀᴋʟᴏᴀᴅ",
    CAPTION: "©𝟐𝟎𝟐𝟓 𝐃𝐀𝐑𝐊 𝐋𝐎𝐀𝐃 𝐗𝐌𝐃 𝐕𝟓",
    BOT_PIC: `https://${process.env.REPLIT_DOMAINS || process.env.REPLIT_DEV_DOMAIN || 'localhost:5000'}/botimage.png`,
    ...
    PACK_NAME: "𝐃𝐀𝐑𝐊 𝐋𝐎𝐀𝐃 𝐗𝐌𝐃",
    PACK_AUTHOR: "𝐃𝐚𝐫𝐤𝐥𝐨𝐚𝐝",
    SUDO_NUMBERS: "",
    PM_PERMIT: "false",
    ANTIVIEWONCE: "indm",
};
